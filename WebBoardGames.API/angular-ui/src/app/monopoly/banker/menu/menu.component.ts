...
import { MonopolyBankerApiService, GameCreateRequest, GameJoinRequest } from 'app/api/monopoly-banker.api-service';
...
@Component({
  ...
  styleUrls: ['../game-styles.scss', './menu.component.scss'],
})
export class MonopolyBankerMenuComponent {
